...
#define Switch_Address_0(i)                                             \
    ((i) ? (DL_GPIO_setPins(Gray_Address_PIN_1_PORT, Gray_Address_PIN_1_PIN)) \
         : (DL_GPIO_clearPins(Gray_Address_PIN_1_PORT,                        \
                              Gray_Address_PIN_1_PIN)))  // 地址位0控制

#define Switch_Address_1(i)                                             \
    ((i) ? (DL_GPIO_setPins(Gray_Address_PIN_2_PORT, Gray_Address_PIN_2_PIN)) \
         : (DL_GPIO_clearPins(Gray_Address_PIN_2_PORT,                        \
                              Gray_Address_PIN_2_PIN)))  // 地址位1控制

#define Switch_Address_2(i)                                             \
    ((i) ? (DL_GPIO_setPins(Gray_Address_PIN_3_PORT, Gray_Address_PIN_3_PIN)) \
         : (DL_GPIO_clearPins(Gray_Address_PIN_3_PORT,                        \
                              Gray_Address_PIN_3_PIN)))  // 地址位2控制
